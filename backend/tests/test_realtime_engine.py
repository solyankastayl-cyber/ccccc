...
Base URL: https://confluence-map.preview.emergentagent.com
"""
...
BASE_URL = os.environ.get('REACT_APP_BACKEND_URL', 'https://confluence-map.preview.emergentagent.com').rstrip('/')
